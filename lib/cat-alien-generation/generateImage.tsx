...
const GenerateImage = React.forwardRef<SVGSVGElement, GenerateImageProps>(
  ({ traits }, ref) => {
    ...
    const generateBlobPath = (
      ...
      for (let i = 0; i <= points.length - 1; i++) {
        ...
        if (i === 0) {
          ...
          const cp2x =
            x + Math.cos(normalAngle) * radiusVariation * 0.3 * bulge;
          const cp2y =
            y + Math.sin(normalAngle) * radiusVariation * 0.3 * bulge;
